...
public partial class xtym : System.Web.UI.Page
{
    string UserName = "";
    string GroupID = "";
    string OID = "";
    ...
    public void bind()
    {
        ...
        //    foreach (Control ctl in this.Page.Master.FindControl("ContentPlaceHolder1").Controls)
        //    {
        //        if (ctl.ID != null && ObjectID == ctl.ID.ToString()) //
        //        {
        //            ((HyperLink)this.Page.Master.FindControl("ContentPlaceHolder1").FindControl(ObjectID)).Enabled = true;
        //            ((HyperLink)this.Page.Master.FindControl("ContentPlaceHolder1").FindControl(ctl.ID.ToString())).CssClass = "button orange";
        //            break;
