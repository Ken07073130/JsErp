<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ypzhpsdEdit.aspx.cs" Inherits="ypzhpsdEdit" %>
               ...
               //样品建议书  流程到总助或者电芯工程师
                  ...
                  if(("-"==document.getElementById('ddlZzhqzt').value)&&("-"==document.getElementById('ddlDxhqzt').value)){
                     if( 
                       ...
                       ||(parseInt(document.getElementById('tbCpsl').value)>=10)&&(document.getElementById('tbBcrl').value=="-")
                      ){
...
//*总助会签
function zzChange(){
  if(document.getElementById('ddlZz').value.length>0){
      var sysDate=new Date(); 
...
function dxChange(){
  if(document.getElementById('ddlDx').value.length>0){
      ...
      if(document.getElementById('trDxxx').style.display!="none"){
          //激活必填项
          ValidatorEnable(document.getElementById('RequiredFieldValidator69'), true);
          ValidatorEnable(document.getElementById('RequiredFieldValidator70'), true); 
          ValidatorEnable(document.getElementById('RequiredFieldValidator71'), true); 
          ValidatorEnable(document.getElementById('RequiredFieldValidator72'), true); 
          ValidatorEnable(document.getElementById('RequiredFieldValidator73'), true);  
          ValidatorEnable(document.getElementById('RequiredFieldValidator74'), true);  
          ValidatorEnable(document.getElementById('RequiredFieldValidator75'), true);  
      }
...
function setFkrq(){
    var sysDate=new Date(); 
    document.getElementById('tbFkrq').value=sysDate.getFullYear()+"-"+(sysDate.getMonth()+1)+"-"+sysDate.getDate();
...
//收费样品 单价必填
function yjjgCheck(){
    if(document.getElementById('ddlSfqk').value=="收费样品"){
...
//内部结构尺寸是否被勾选
function dxxxRequired(){
      //备选条件document.getElementById('ddlDx').value.length>0
      if(document.getElementById('ddlCpzt').value=="PACK"&&document.getElementById('cbCzggs').checked){
        document.getElementById('trDxxx').style.display="";
      } else {
        document.getElementById('trDxxx').style.display="none";
...
function packClick(){
   if(document.getElementById('cbBhb').checked){
     document.getElementById('tbGG').value="-"; 
     document.getElementById('tbDlglicgg').value="-"; 
     document.getElementById('tbNTCZZ').value="-"; 
     document.getElementById('tbBz').value="-"; 
     document.getElementById('tbHolddl').value="-"; 
     document.getElementById('tbTripdl').value="-"; 
     document.getElementById('tbMosgyq').value="-"; 
     
   }
   if(document.getElementById('cbDzx').checked){
     document.getElementById('tbCxwz').value="-"; 
     document.getElementById('tbWxlc').value="-"; 
     document.getElementById('tbXtgxcd').value="-"; 
   }
   if(document.getElementById('cbSjk').checked){
     document.getElementById('tbSjkys').value="-"; 
     document.getElementById('tbSjkcz').value="-"; 
     document.getElementById('tbFhdj').value="-";
   }
   if(document.getElementById('cbSmj').checked){
     document.getElementById('tbGGXH').value="-"; 
     document.getElementById('tbNTWZ').value="-"; 
   }
   if(document.getElementById('cbCtx').checked){
     document.getElementById('tbLjqpp').value="-"; 
     document.getElementById('tbLjqgg').value="-"; 
     document.getElementById('tbDzmxsnr').value="-"; 
     document.getElementById('tbDzmxxnr').value="-"; 
   }
}
...
function setRequired(){
   //“按照以上版本的规格书内容制作样品”打钩时，“成品尺寸类型”“循环周期”自动填写“-”
   if(document.getElementById('cbAzggs').checked){
      document.getElementById('tbXhzq').value="-";
      document.getElementById('ddlCpcclx').value="-";
   }
...
window.onload=function divVisible(){
   ...
   dxxxRequired();//PACK的单子需要电芯人员填写电芯信息               
}
...
//总电芯数量>=30PCS,需要填写联络单或者客户订单号
function zdxslChange(){
    if(parseInt(document.getElementById('tbZdxsl').value)>=30){
       ValidatorEnable(document.getElementById('RequiredFieldValidator76'), true);
    }else {
       ValidatorEnable(document.getElementById('RequiredFieldValidator76'), false);
    }
}
...
<body>
    <form id="form1" runat="server">
        <div id="divAll">
            ...
            <div id="divNav" runat="server" visible="false">
                <ul class="ulTab">
            ...
            <div align="center" id="divTab1">
                <div style="font-size: 12px;">
                    ...
                    <table width="760" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#F1FEDD"
                            ...
                            <td colspan="12">
                                ...
                                <div runat="server" id="divYpjys" style="font-size: 11px; font-weight: normal; border-top: 1px  solid #000;
                                    ...
                                    <label id="lbDxsl" runat="server" visible="false">
                                        &nbsp; &nbsp;&nbsp;&nbsp; 收费情况
                                        <asp:DropDownList ID="ddlSfqk" runat="server" onchange="yjjgCheck()">
                                        ...
                                        <asp:TextBox ID="tbZdxsl" runat="server" Width="60px" onchange="zdxslChange()"></asp:TextBox><asp:RequiredFieldValidator
                                        ...
                                        </asp:RequiredFieldValidator><asp:RangeValidator ID="RangeValidator1" runat="server"
                                            ErrorMessage="只接受1-30PCS内的样品单" MinimumValue="0" MaximumValue="30" Type="Integer" ControlToValidate="tbZdxsl" Enabled="false"></asp:RangeValidator><asp:RegularExpressionValidator ID="RegularExpressionValidator1"
                        ...
                        <tr id="trTdls" runat="server" visible="true">
                        ...
                        <tr id="trKhxx" runat="server">
                            ...
                            <td colspan="4" style="height: 47px">
                                <asp:TextBox ID="tbKhdm" runat="server" Width="90%" AutoPostBack="True" OnTextChanged="tbKhdm_TextChanged"></asp:TextBox><asp:RequiredFieldValidator
                            ...
                            <td style="width: 75px; height: 47px" >
                                合作关系</td>
                             <td style="width: 75px; height: 47px" colspan="5" >
                                 <asp:DropDownList ID="ddlHzgx" runat="server">
                                     <asp:ListItem>请选择</asp:ListItem>
                                     <asp:ListItem>已合作</asp:ListItem>
                                     <asp:ListItem>未合作</asp:ListItem>
                                 </asp:DropDownList>
                                 <asp:CompareValidator ID="CompareValidator10" runat="server" ControlToValidate="ddlHzgx"
                                     Display="Dynamic" EnableTheming="true" ErrorMessage="请选择是否为合作客户" Operator="NotEqual"
                        ...
                        <tr id="trZyx" runat="server">
                            ...
                            <td style="width: 75px; height: 47px" class="tdNeed">
                                应用领域</td>
                        ...
                        <tr id="trKhxxKhxh" runat="server">
                            ...
                            <td colspan="4" style="height: 47px">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator42" runat="server" ControlToValidate="tbKhxh"
                                    Display="Dynamic" ErrorMessage="请填写客户型号" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="客户型号至少需要6位"
                                 Display="Dynamic" ControlToValidate="tbKhxh"  ValidationExpression="^.{6,}$" >
                                </asp:RegularExpressionValidator></td>
                            <td class="tdNeed" style="width: 75px; height: 47px">
                                库存电池<br />
                                （2013年1月1日以后）</td>
                            <td colspan="5" style="height: 47px">
                                ...
                                <asp:CompareValidator ID="CompareValidator11" runat="server" ControlToValidate="ddlKcdc"
                                    Display="Dynamic" Enabled="false" EnableTheming="true" ErrorMessage="请选择是否有库存电池"
                        ...
                        <tr runat="server" id="trYqjhjq">
                            ...
                            <td class="tdNeed" style="width: 75px; height: 47px">
                                库存数量</td>
                            <td colspan="5" style="height: 47px"><asp:DropDownList ID="ddlKcsl" runat="server" >
                                <asp:ListItem>请选择</asp:ListItem>
                                <asp:ListItem>≥2K</asp:ListItem>
                                <asp:ListItem>＜2K</asp:ListItem>
                            </asp:DropDownList><asp:CompareValidator ID="CompareValidator4" runat="server" ControlToValidate="ddlKcsl"
                                Display="Dynamic" Enabled="false" EnableTheming="true" ErrorMessage="请选择库存数量"
                                Operator="NotEqual" SetFocusOnError="true" Type="string" ValueToCompare="请选择">
                                </asp:CompareValidator>&nbsp;</td>
                        </tr>
                    ...
                    <table width="760" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#F1FEDD"
                        ...
                        <tr>
                            <td rowspan="15">
                                &nbsp;客户需求 &nbsp;</td>
                                <td style="height: 37px" class="tdNeed">
                                成品状态&nbsp;</td>
                          ...
                          <td style="height: 50px">
                            ...
                            <td style="height: 50px" colspan="5">
                                ...
                                <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" CompletionInterval="200"
                                    CompletionSetCount="25" EnableCaching="true" MinimumPrefixLength="1" ServiceMethod="GetDxxhList" ServicePath="~/GetContent.asmx"
                                    TargetControlID="tbNbxh">
                                </ajaxToolkit:AutoCompleteExtender>
                                &nbsp;&nbsp;
                                <asp:CustomValidator ID="CustomValidator1" runat="server" Display="Dynamic" SetFocusOnError="true"
                                    ControlToValidate="tbNbxh" OnServerValidate="CustomValidator1_ServerValidate" Enabled="false"></asp:CustomValidator>
                        ...
                        <tr>
                            <td style="height: 48px" colspan="6">
                        ...
                        <tr>
                            <td style="height: 48px" class="tdNeed">
                                标称容量<br />
                                &nbsp; (mAh)</td>
                            <td style="height: 48px">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td rowspan="6" width="10%">
                                            保护板<br />
                                            <asp:CheckBox ID="cbBhb" runat="server"  Text="不需要" onclick="packClick()"/></td>
                                    ...
                                    <tr>
                                        <td width="10%" rowspan="3">
                                            电子线<br />
                                            <asp:CheckBox ID="cbDzx" runat="server"  Text="不需要"  onclick="packClick()" /></td>
                                        <td style="height: 42px" width="10%">
                                            出线位置</td>
                                        <td colspan="8" style="height: 42px">
                                    ...
                                    <tr>
                                        <td colspan="3" style="height: 42px">
                                            外露线长±3mm：<asp:TextBox ID="tbWxlc" runat="server" Width="40%"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator46" runat="server" ControlToValidate="tbWxlc"
                                                Display="Dynamic" ErrorMessage="请填写外露线长" SetFocusOnError="true"></asp:RequiredFieldValidator></td>
                                        <td style="height: 42px" colspan="3">
                                    ...
                                    <tr>
                                        <td width="10%" rowspan="2">
                                            插头线<br />
                                            <asp:CheckBox ID="cbCtx" runat="server"  Text="不需要"  onclick="packClick()" /></td>
                                        <td style="height: 42px" colspan="2">
                                            连接器品牌</td>
                                        <td style="height: 42px;" colspan="2">
                                    ...
                                    <tr>
                                        <td rowspan="2" width="10%">
                                            塑胶壳<br />
                                            <asp:CheckBox ID="cbSjk" runat="server"  Text="不需要" onclick="packClick()" /></td>
                                        <td style="height: 42px" width="10%">
                                            颜色</td>
                                        <td colspan="2" style="height: 42px">
                                    ...
                                    <tr>
                                        <td style="height: 42px" width="10%">
                                            双面胶<br />
                                            <asp:CheckBox ID="cbSmj" runat="server"  Text="不需要" onclick="packClick()" /></td>
                                        <td style="height: 42px" width="10%">
                                            品牌</td>
                                        <td colspan="2" style="height: 42px">
                    ...
                    <table width="760" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#F1FEDD"
                        ...
                        <tr>
                            ...
                            <td style="width: 60px; height: 47px" class="tdNeed">
                                制作情况</td>
                            <td style="height: 47px" colspan="2">
                                <asp:DropDownList ID="ddlZzqk" runat="server" OnSelectedIndexChanged="ddlZzqk_SelectedIndexChanged">
                                    <asp:ListItem>请选择</asp:ListItem>
                                    <asp:ListItem>库存出货</asp:ListItem>
                                    <asp:ListItem>样品新做</asp:ListItem>
                                    <asp:ListItem>无库存需制样</asp:ListItem>
                                    <asp:ListItem>制手工样本</asp:ListItem>
                                </asp:DropDownList></td>
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="height: 47px">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="tbYjjg"
                                    Display="Dynamic" Enabled="false" ErrorMessage="收费样品请填写样品单价"></asp:RequiredFieldValidator>
                            ...
                            <td class="tdNeed" colspan="6" style="height: 47px">
                                ...
                                次送样<br />
                                &nbsp;<asp:CompareValidator ID="CompareValidator9" runat="server" ControlToValidate="ddlDjcsy"
                    ...
                    <table width="760" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#F1FEDD"
                        ...
                        <tr bgcolor="#CCFFFF" id="trScqj" runat="server">
                            ...
                            <td colspan="4" style="height: 47px">
                                3.市场风险简述</td>
                            <td colspan="3" style="height: 47px" class="tdNeed">
                                4.评估结论</td>
                        </tr>
                        <tr bgcolor="#CCFFFF" id="trScqjnr" runat="server">
                            ...
                            <td colspan="3" rowspan="3" style="height: 33px">
                    ...
                    <table width="760" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#F1FEDD"
                        ...
                        <tr bgcolor="#CCFFFF">
                            <td style="width: 60px; height: 36px" id="tdSwjl" runat="server">
                                &nbsp;商务经理</td>
                            ...
                            <td style="height: 36px; width: 60px;" id="tdZg" runat="server">
                                &nbsp;总工</td>
                        ...
                        <tr bgcolor="#ccffff" id="trZzps" runat="server">
                            <td runat="server" style="width: 60px; height: 36px" id="Td3">
                                总经理助理</td>
                            <td colspan="4" style="height: 36px">
                            ...
                            <td runat="server" style="width: 60px; height: 36px" id="Td4">
                            </td>
                            <td colspan="6" style="height: 36px">
                            </td>
                        </tr>
                        <tr bgcolor="#ccffff" id="trGcsps" runat="server">
                            <td runat="server" style="width: 60px; height: 36px" id="Td5">
                                电芯工程师</td>
                            <td colspan="4" style="height: 36px">
                            ...
                            <td runat="server" style="width: 60px; height: 36px" id="Td6">
                                转交电芯工程师</td>
                            <td colspan="6" style="height: 36px"><asp:DropDownList ID="ddlZjdxgcs" runat="server" Width="45%">
                            </asp:DropDownList></td>
                        </tr>
                        <tr runat="server" bgcolor="#ccffff" id="trDxxx">
                            <td runat="server" style="height: 36px" colspan="12" id="Td9">
                                电芯型号<asp:TextBox ID="tbDxDxxh" runat="server" Width="9%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator69" Display="Dynamic" runat="server" ErrorMessage="请填写电芯型号" ControlToValidate="tbDxDxxh" Enabled="false"></asp:RequiredFieldValidator>容量<asp:TextBox
                                    ID="tbDxrl" runat="server" Width="7%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator70" Display="Dynamic" runat="server" ControlToValidate="tbDxrl"
                                    Enabled="false" ErrorMessage="请填写电芯容量"></asp:RequiredFieldValidator>厚(mm)<asp:TextBox ID="tbDxCch"
                                        runat="server" Width="5%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator71" Display="Dynamic" runat="server" ControlToValidate="tbDxCch"
                                    Enabled="false" ErrorMessage="请填写厚度"></asp:RequiredFieldValidator>宽(mm)<asp:TextBox ID="tbDxCck" runat="server"
                                            Width="6%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator72"  Display="Dynamic" runat="server" ControlToValidate="tbDxCck"
                                    Enabled="false" ErrorMessage="请填写宽度"></asp:RequiredFieldValidator>高(mm)<asp:TextBox ID="tbDxCcc" runat="server" Width="5%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator73" Display="Dynamic" runat="server" ControlToValidate="tbDxCcc"
                                    Enabled="false" ErrorMessage="请填写高度"></asp:RequiredFieldValidator>内阻<asp:TextBox
                                                ID="tbDxnz" runat="server" Width="9%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator74" Display="Dynamic" runat="server" ControlToValidate="tbDxnz"
                                    Enabled="false" ErrorMessage="请填写内阻"></asp:RequiredFieldValidator>极耳中心距(mm)<asp:TextBox ID="tbDxJezxj"
                                                    runat="server" Width="9%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator75" Display="Dynamic" runat="server" ControlToValidate="tbDxJezxj"
                                    Enabled="false" ErrorMessage="请填写极耳中心距"></asp:RequiredFieldValidator></td>
                        </tr>
                        <tr id="trPackgcs" runat="server" bgcolor="#ccffff">
                            <td id="Td1" runat="server" style="width: 60px; height: 36px">
                                PACK工程师</td>
                            <td colspan="4" style="height: 36px">
                            ...
                            <td id="Td2" runat="server" style="width: 60px; height: 36px">
                                转交PACK工程师</td>
                            <td colspan="6" style="height: 36px">
                        ...
                        <tr bgcolor="#ccffff">
                            <td style="width: 60px; height: 37px">
                                评审批注</td>
                            <td colspan="11" style="height: 37px">
                        ...
                        <tr runat="server" bgcolor="#ccffff" id="trXh">
                            <td id="Td7" runat="server" style="width: 60px; height: 36px">
                                成品电芯型号</td>
                            <td colspan="4" style="height: 36px">
                            ...
                            <td id="Td8" runat="server" style="width: 60px; height: 36px">
                                成品PACK型号</td>
                            <td colspan="6" style="height: 36px">
                         ...
                         <tr bgcolor="#ccffff" id="trGGS4" runat="server">
                            <td colspan="5" style="height: 39px">
                                <asp:CheckBox ID="cbWlwdyq" runat="server" Text="物料未到延期" OnCheckedChanged="cbWlwdyq_CheckedChanged" />&nbsp;</td>
                        ...
                        <tr bgcolor="#ccffff" id="trGGS2" runat="server">
                            ...
                            <td style="width: 60px; height: 39px">
                                实验室评审交期</td>
                            <td colspan="6" style="height: 39px">
                            <asp:TextBox ID="tbSwyjjq" runat="server" Width="90%"></asp:TextBox>
                            </td>
                            
                        </tr>
                        <tr bgcolor="#ccffff" id="trGGS3" runat="server" visible="true">
                            <td style="width: 60px; height: 39px">
                                是否需要退单</td>
                            <td colspan="4" style="height: 39px">
                    ...
                    <div style="display: none">
                        ...
                        <asp:RequiredFieldValidator id="RequiredFieldValidator76" runat="server" SetFocusOnError="true" ErrorMessage="电芯数量>=30PCS时请填写联络单或客户订单号" 
                        Display="Dynamic" ControlToValidate="tbLldhkhddh" Enabled="false"></asp:RequiredFieldValidator>
                    </div>
                </div>
            </div>
            <!--第一页结束-->
                ...
                <table width="710" border="0" cellspacing="0" cellpadding="0" bgcolor="#F1FEDD">
                    ...
                    <tr>
                        ...
                        <td colspan="7" style="height: 63px">
                            <asp:TextBox ID="tbKhcsqk" runat="server" Height="47px" TextMode="MultiLine" Width="95%" onchange="setFkrq()"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td colspan="7" style="height: 63px">
                            <asp:TextBox ID="tbFkddqk" runat="server" Height="47px" TextMode="MultiLine" Width="95%" onchange="setFkrq()"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td colspan="10" style="height: 63px">
                            <asp:TextBox ID="tbFkrq" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="height: 63px">
                            客户使用<br />
