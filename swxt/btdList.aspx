    ...
    <form id="form1" runat="server">
        <div style="margin: 0 auto; width: 100%; font-size: 12px;">
            <div style="text-align: center; font-size: 25px; font-weight: bold; background-color: #FFFFCC;">
                ...
                </span><span runat="server" id="spanTitle"></span>补投单列表</div>
            <div style="margin: 0 auto; width: 1100px; overflow: auto;">
                ...
                <div style="margin-bottom: 5px;">
                    ...
                    <asp:LinkButton ID="lbQuery" runat="server" Style="font-size: 13px; color: white;
                        ...
                        Width="71px" OnClick="lbQuery_Click">查询</asp:LinkButton></div>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ddh" HeaderText="单号" ItemStyle-Width="150" />
                    </Columns>
                    <PagerTemplate>
