<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="ckglym.aspx.cs" Inherits="ckglym" Title="金色能源ERP-仓库管理模块" %>
...
<div  class="wrap">
    <div id="div1" class="div2" align="center" >
        ...
        <div class="div4" >成品库管理</div>
        <div style=" height:5px;"></div>
        <asp:HyperLink  CssClass="button orange" id ="B_1192"  runat="server"  NavigateUrl="~/wzjsz.aspx"  text ="成品出入库" /> 
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="B_1195"  runat="server"  NavigateUrl="~/wzjsz.aspx"  text="成品仓整理单" /> 
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="B_1124"  runat="server"  NavigateUrl="~/wzjsz.aspx"  text="手工数据对账单" /> 
        <div style=" height:5px;"></div>
        <div class="div4"></div>
        <div style=" height:5px;"></div>
        <div class="div4"></div>
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="B_1223"  runat="server"   NavigateUrl="~/wzjsz.aspx"  text="成品出入库明细" /> 
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="B_1194"  runat="server"   NavigateUrl="~/wzjsz.aspx"  text="成品库库存查询" /> 
        <div style=" height:5px;"></div>
        <div class="div4"></div>
        <div style=" height:5px;"></div>
    </div>
    ...
    <div  align="center" class="div2" >
        <div style=" height:5px;"></div>
        <div class="div4" >材料库管理</div>
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="B_1196"  runat="server"  NavigateUrl="~/wzjsz.aspx"  text="主材采购入库单" /> 
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="B_1199"  runat="server"   NavigateUrl="~/wzjsz.aspx"  text="报检不合格退仓单" /> 
        <div style=" height:5px;"></div>
        <div class="div4" ></div>
        <div style=" height:5px;"></div>
        <div class="div4" ></div>
