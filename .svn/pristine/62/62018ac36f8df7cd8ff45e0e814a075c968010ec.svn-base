<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="jxkh_bmlr_lb.aspx.cs" Inherits="jxkh_bmlr_lb" Title="生产日报" %>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#FFFFE0">
                         <tr >
                             <td rowspan="2" align="center" style="height: 31px" bgcolor="#FEEDC9" >
                                 <div style="margin:10px 0px;"><asp:LinkButton ID="lbTjbd" runat="server" OnClick="tjbd_Click" style="background-color:#FEEDC9;display: block ;text-align: center;color: #d84700;  font-size: 14px; font-weight: bold; text-decoration: none; " Width="120px">添加新考核规则</asp:LinkButton></div>
                         ...
                         <tr valign="top">
                             <td style="height: 199px; width: 1168px;">
                                 <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" style="text-align: center" EmptyDataText="无记录"
                                     ...
                                     <Columns >
                                        <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="jxkh_pz.aspx?id={0}"
                                             DataTextField="id" HeaderText="ID"  ItemStyle-Width="5%"/>
                                         <asp:BoundField DataField="zbmc" HeaderText="指标名称">
                                             <ItemStyle Width="25%" />
                                         </asp:BoundField>
                                         <asp:BoundField DataField="jbmc" HeaderText="指标级别">
                                             <ItemStyle Width="8%" />
                                         </asp:BoundField>
                                        <asp:BoundField DataField="gzlx" HeaderText="规则类型">
                                             <ItemStyle Width="15%" />
                                         </asp:BoundField>
                                         <asp:BoundField DataField="gs" HeaderText="公式">
                                             <ItemStyle Width="30%" />
                                         </asp:BoundField>
                                           <asp:BoundField DataField="zbsx" HeaderText="是否有效">
                                             <ItemStyle Width="8%" />
                                         </asp:BoundField>
