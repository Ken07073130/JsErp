<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BOMym.aspx.cs" Inherits="BOMym" Title="金色能源ERP-BOM模块" %>
...
<div  class="wrap">
    <div id="div1" class="div2" align="center" >
        ...
        <div class="div4" >物料录入</div>
        <div style=" height:5px;"></div>
        <asp:HyperLink  CssClass="button orange" id ="BHyperLink1"  runat="server"  NavigateUrl="~/wzjsz.aspx" text ="物料编码添加" /> 
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="B_1243"  runat="server"  NavigateUrl="~/wzjsz.aspx"  text="物料编码信息表" /> 
        <div style=" height:5px;"></div>
        <div class="div4"></div>
        <div style=" height:5px;"></div>
        <div class="div4"></div>
        ...
        <div class="div4"></div>
        <div style=" height:5px;"></div>
         <asp:HyperLink CssClass="button orange" id ="B_1202"  runat="server"   NavigateUrl="~/wzjsz.aspx"  text="物料分类添加" /> 
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="B_1207"  runat="server"   NavigateUrl="~/wzjsz.aspx"  text="浆料配方表" /> 
        <div style=" height:5px;"></div>
         <div class="div4"></div>
        <div style=" height:5px;"></div>
    </div>
    ...
    <div  align="center" class="div2" >
        <div style=" height:5px;"></div>
        <div class="div4" >BOM录入</div>
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="B_1205"  runat="server"  NavigateUrl="~/wzjsz.aspx"  text="新BOM主" /> 
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="B_1206"  runat="server"  NavigateUrl="~/wzjsz.aspx" text="新BOM子" /> 
        <div style=" height:5px;"></div>
        <div class="div4"></div>
        <div style=" height:5px;"></div>
        <div class="div4"></div>
    ...
    <div  align="center" class="div2" >
        ...
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="B_1203"  runat="server"   NavigateUrl="~/wzjsz.aspx"  text="新物料编码添加" /> 
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="BHyperLink2"  runat="server"  NavigateUrl="~/wzjsz.aspx" text="新BOM添加" /> 
        <div style=" height:5px;"></div>
        <div class="div4"></div>
        <div style=" height:5px;"></div>
        <div class="div4"></div>
