<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="gylym.aspx.cs" Inherits="gylym" Title="金色能源ERP-供应链模块" %>
...
<div  class="wrap">
    <div id="div1" class="div2" align="center" >
        ...
        <div class="div4" >供应链</div>
        <div style=" height:5px;"></div>
        <asp:HyperLink  CssClass="button orange" id ="B_1235"  runat="server"  NavigateUrl="~/wzjsz.aspx" text ="供应商管理" /> 
        <div style=" height:5px;"></div>
        <div class="div4"></div>
        <div style=" height:5px;"></div>
        <div class="div4"></div>
        ...
        <div class="div4"></div>
        <div style=" height:5px;"></div>
        <asp:HyperLink CssClass="button orange" id ="B_1236"  runat="server"   NavigateUrl="~/wzjsz.aspx"   text="供应商基本信息查询" /> 
        <div style=" height:5px;"></div>
        <div class="div4"></div>
        <div style=" height:5px;"></div>
         <div class="div4"></div>
