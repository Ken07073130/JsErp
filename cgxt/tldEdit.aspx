...
<head runat="server">
    ...
    <script type="text/javascript">
           ...
           function showLog(){
              if (document.getElementById('aLog').innerHTML=="显示日志"){
                 document.getElementById("aLog").innerHTML="收起日志";
                 document.getElementById("divLog").style.display="";
              } else if (document.getElementById("aLog").innerHTML=="收起日志"){
                 document.getElementById("aLog").innerHTML="显示日志";
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <div id="divPage">
                        ...
                        <div class="layout">
                            <ul>
                                ...
                                <li><span class="spanLabel">版本</span><span class="spanControl"><asp:DropDownList
                                    ID="ddlBB" runat="server" OnSelectedIndexChanged="ddlBB_SelectedIndexChanged"
                                    AutoPostBack="True">
                                    <asp:ListItem>1.0</asp:ListItem>
                                </asp:DropDownList>
                                    <a id="aLog" href="javascript:void(0);" onclick="showLog()">显示日志</a></span> </li>
                            </ul>
                        </div>
                        <div id="divLog" style="display: none;">
                            <asp:TextBox ID="tbBgnr" runat="server" Width="100%" ReadOnly="true" TextMode="MultiLine"
                                Rows="15"></asp:TextBox>
                        </div>
                        <div class="layout">
                            <ul>
                        ...
                        <div id="divDjxx" style="display: none">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="bzxh" HeaderText="">
                                        <ControlStyle CssClass="hidden" />
                                        <FooterStyle CssClass="hidden" />
                                        <HeaderStyle CssClass="hidden" />
                                        <ItemStyle CssClass="hidden" />
                            ...
                            <div class="layout">
                                <ul>
                                    ...
                                    <li><span class="spanLabel">电芯定额版本</span> <span class="spanControl">
                                        <asp:DropDownList ID="ddlDxdebb" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDxdebb_SelectedIndexChanged">
                                        </asp:DropDownList>
                                        <asp:TextBox ID="tbDxwjbh" runat="server"></asp:TextBox></span></li></ul>
                            </div>
                            <div class="layout">
                                <ul>
                            ...
                            <div class="layout">
                                <ul>
                                    ...
                                    <li><span class="spanLabel">PACK定额版本</span> <span class="spanControl">
                                        <asp:DropDownList ID="ddlPackDebb" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDxdebb_SelectedIndexChanged">
                                        </asp:DropDownList>
                                        <asp:TextBox ID="tbPackwjbh" runat="server"></asp:TextBox></span></li></ul>
                            </div>
                            <div class="layout">
                                <ul>
                        ...
                        <div class="layout">
                            <ul>
                                <li><span class="spanLabel">包装型号</span><span class="spanControl"><asp:TextBox ID="tbBzxh"
                                    runat="server" Width="90%" BackColor="Silver"></asp:TextBox></span> </li>
                                <li><span class="spanLabel">包装定额版本</span><span class="spanControl"><asp:DropDownList
                                    ID="ddlBzdebb" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDxdebb_SelectedIndexChanged">
                                </asp:DropDownList>
                                    <asp:TextBox ID="tbBzwjbh" runat="server"></asp:TextBox></span> </li>
                            </ul>
                        </div>
                        <div class="layout">
                            <ul>
                                <li><span class="spanLabel">包装定额编号</span><span class="spanControl"><asp:TextBox ID="tbBzdebh"
                                    runat="server" Width="90%"></asp:TextBox></span> </li>
                     
                                     <li><span class="spanLabel">包装投产量</span><span class="spanControl"><asp:TextBox ID="tbBztcl"
                                    runat="server" Width="90%"></asp:TextBox></span> </li>
                            </ul>
                        </div>
                        <div class="layout">
                        ...
                        <div style="width: 1000px; margin: 0 auto; background-color: Black;">
                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="3"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="sfcg" HeaderText="是否已采购">
                                        <ItemStyle Width="5%" />
                                    </asp:BoundField>
                                </Columns>
